...
across neural structures.  *Perception*, 37:401-407, PMID: 18491717. 2008.
...
and press the recreate button. When the model stops (after about 2 1/4 minutes on a 2.8GHz Pentium 4) a graph similar to figure 1 b from the paper will be displayed:
...
at top of mosinit.hoc -- can switch to 0 if want to run again after first run to inhibit re-creation of the net.net network connectivity file.

graphics shows excitatory (blue) and inhibitory (red) raster

individual inhibitory (IN) and excitatory (SU) cells from each column are available from the menu.
